...
- Pair up  
- Exchange github account names  
- Take a look at your partner's HW 1 .Rmd file  
- Answer these questions (to yourself):  
  + Is there a title and author name in the YAML at the top? 
  + Is it easy to find the code in the Rmd file?  
  + Is all of the code contained in an R code chunk?
  ![](pics/chunk.png)
  + Is all of the text outside of the code chunks?  
  + Without actually running the code, do you think it will do what it's supposed to do?  
- Ask your partner any questions you have about their HW solution?  
- Now go back and fix any mistakes you think you have and resubmit   your HW.
